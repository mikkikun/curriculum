...
//	　<以下記述>
			int indexNumber = array.indexOf("foo");
			System.out.println("fooのインデックス：" + indexNumber);
...
//	    <以下記述>
       	...
       	//arrayDate list = new arrayDate();
       	//List<Integer> list = Arrays.asList(arrayDate);
       	//List<String> list = new ArrayList<>(Arrays.asList(arrayDate));
